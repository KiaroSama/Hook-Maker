...
# The UPDATE flow - refreshing installations that already exist, asking no
# configuration question - lives in Setup-SyncGroupUpdateFlow.ps1 (split at the
# 800-line ceiling). Dot-sourced HERE, in the position it occupied, so the
# sub-menu below dispatches to it unchanged.
. (Join-Path $PSScriptRoot 'Setup-SyncGroupUpdateFlow.ps1')
