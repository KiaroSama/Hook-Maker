...
# Every generated hook opens with this. A generated hook is STANDALONE (it does
# not dot-source hooks\_hooklib.ps1), so it needs its own copy of the same UTF-8
# I/O contract _hooklib pins for the shipped hooks: [Console]::In decodes with
# the console code page, and a hook spawned without an attached console reports
# the machine's OEM page (ibm437 here), which corrupts every non-ASCII prompt,
# path, and forbidden word before the generated logic ever sees it.
$Utf8IoPrelude = @'
