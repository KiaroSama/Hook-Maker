...
# ------------------------------------------------- the group as data ----
# The full-mesh profile build, the membership helper, the transitive-closure
# merge and the display name live in Setup-SyncGroupModel.ps1 (split at the
# 800-line ceiling). Dot-sourced HERE, in the position the block occupied, so
# the flow below and Test-SyncGroupMerge.ps1 both reach them unchanged.
. (Join-Path $PSScriptRoot 'Setup-SyncGroupModel.ps1')
