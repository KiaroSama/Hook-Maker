...
# the table later - which is exactly what happened to a client added without a
# display name: it rendered as a bare lowercase id beside the properly-cased
# ones. An id the table does not
