...
try {
    ...
    function New-ManagedCleanupInstall {
        ...
        $runtimeLeaves = @('_hooklib.ps1', '_stoplib.ps1', '_evidencelib.ps1', '_taskidentity.ps1', '_scope.ps1', '_deliverylib.ps1', '_processtree.ps1', '_gatereceipts.ps1', '_replylanguage.ps1', 'Test-Temp-Cleanup.ps1')
