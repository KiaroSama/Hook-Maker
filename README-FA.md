...
2. **ساخت یا نصب هوک دلخواه** — دو زیرگزینه دارد:
   - **ساخت هوک جدید (با قالب آماده):** اسم هوک را بده، یکی از چهار قالب را انتخاب کن، به یکی-دو سوال جواب بده و یک هوک کامل و کارا در `hooks\` ساخته می‌شود (و در صورت تایید همان‌جا نصب می‌شود):
     ...
     4. **Empty skeleton** — اسکلت کامنت‌گذاری‌شده برای منطق دلخواه خودت.
